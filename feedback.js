...
function boot(){
  addStyles();addFeedbackTab();reliabilityInfo();annotatePlayerRows();addModalCloseButtons();
  ...
  const observer=new MutationObserver(()=>{reliabilityInfo();annotatePlayerRows();addDeletePlayerButton();addModalCloseButtons();addFeedbackTab();});observer.observe(document.body,{childList:true,subtree:true});
